...
export const Navbar = (): JSX.Element => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-nav flex justify-center px-6 py-4 pointer-events-none max-sm:px-3.5 max-sm:py-3">
      <nav className="pointer-events-auto flex items-center justify-between gap-8 w-full max-w-[1100px] px-[22px] py-3 rounded-pill bg-[rgba(11,16,36,0.55)] border border-border backdrop-blur-[18px] shadow-[0_10px_35px_-18px_rgba(7,9,24,0.85)] max-sm:px-4 max-sm:py-2.5 max-sm:gap-3 relative">
        <button
          type="button"
